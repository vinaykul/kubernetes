...
# Because regions are globally named, we want to create in a single region; default to us-east-2
...
KUBE_OS_DISTRIBUTION="${KUBE_OS_DISTRIBUTION:-bionic}"
