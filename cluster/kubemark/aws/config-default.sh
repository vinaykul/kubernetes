...
KUBEMARK_NODE_OBJECT_SIZE_BYTES=${KUBEMARK_NODE_OBJECT_SIZE_BYTES:-15000}

MASTER_OS_DISTRIBUTION=${KUBE_MASTER_OS_DISTRIBUTION:-bionic}
NODE_OS_DISTRIBUTION=${KUBE_NODE_OS_DISTRIBUTION:-bionic}
